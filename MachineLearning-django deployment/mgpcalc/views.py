...
reloadModel=joblib.load('C:/Users/Robin/projects2020/MachineLearning/model/RFModelforMPG.pkl')
...
def viewDatabase(request):
    ...
    myresult = collectionD.find().limit(5)
    for x in myresult:
      dbList.append(x)
    context={'countOfrow':countOfrow,'dbList':dbList}
